...
RECOVERY_WELCOME := 欢迎访问：bbs.cn314.com
RECOVERY_BUILD_DATE := 编译日期: $(shell date +%F)
RECOVERY_VERSION_INFO := 技术支持：weibo.com/APAR
...
BOARD_RECOVERY_DEFINES := BOARD_RECOVERY_SWIPE BOARD_HAS_NO_SELECT_BUTTON BOARD_UMS_LUNFILE BOARD_RECOVERY_ALWAYS_WIPES BOARD_RECOVERY_HANDLES_MOUNT BOARD_TOUCH_RECOVERY RECOVERY_EXTEND_NANDROID_MENU TARGET_USE_CUSTOM_LUN_FILE_PATH TARGET_DEVICE TARGET_RECOVERY_FSTAB BOARD_RECOVERY_USE_RAINBOW
...
ifeq ($(BOARD_USE_FB2PNG),true)
    include $(commands_recovery_local_path)/fb2png/Android.mk
endif
ifeq ($(BOARD_USE_AROMA_FILE_MANAGER),true)
